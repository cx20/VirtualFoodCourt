  ...
  html: `
    ...
    <div class="lab" id="lab12">
      ...
      <p class="hint">
        ...
        それでも、無関係なノイズにした瞬間に、焼けたようには見えなくなります。
      </p>
    </div>
...
mat.subSurface.translucencyIntensity = <span class="n">0.45</span>;</pre>
    ...
    <div class="trap">
      ...
      13本のサンプルの値はだいたい 0.2〜0.5 で、1.0 に近い値はどこにもありません。</p>
    </div>`,
  tryIt: [
   ...
   ================================================================== */
{
  ...
  html: `
    ...
    <p>
      ...
      13本に同じ間違いが独立して書かれていたら、13か所直すことになります。
      実際には、団子シリーズ4本のコメントに
    ...
    <p>
      ...
      「ごはん.js の続き」——13本は独立した作品ではなく、1本の連続した記録です。
    </p>
...
sable: {
    ...
    <h3>ここまで来たら</h3>
    <p>
      13本のうち好きな1本を選んで、<b>14本目を作ってみてください</b>。
  ...
  tryIt: [
    ...
    "14本目に作りたい料理を1つ決めて、13本のどれをコピー元にするか選ぶ。"
  ]
}
